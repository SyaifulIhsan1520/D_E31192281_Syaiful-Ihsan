...
$kendaraan1 = new Kendaraan("Avanza", "Mobil", 4, "Toyota", "Premium", 187600000, 2021);
...
$kendaraan2 = new Kendaraan("Terios", "Mobil", 4, "Daihatsu", "Pertamax", 200000000, 2021);
